...
for m = 1:numel(metrics_cell)
    ...
    switch m
        case 1
            y_charray = 'Mean Intensity (AU)';
        case 2
            y_charray = 'Integrated Intensity(AU)';
        case 3
            y_charray = 'Maximum Intensity(AU)';
        case 4
            y_charray = 'Mean Intensity/\mum^3';
        case 5
            y_charray = 'Volume (\mum^3)';
        case 6
            y_charray = 'Std Rescaled Intensity (AU)';
    end
    ylabel(y_charray);
